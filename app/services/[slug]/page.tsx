  ...
  return (
    <Layout className="flex-1 bg-[#0a0a12] flex flex-col items-center w-full">
      <div className="w-full flex flex-col">
        {/* Focused Hero - No generic stats, just the core offer */}
        <section className="relative flex flex-col items-center text-center py-20 md:py-24 overflow-hidden border-b border-border-dark">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed font-light max-w-3xl mx-auto mb-8">
              {service.heroSubtext}
            </p>
            <Link
              href="/contact"
        ...
        <section className="max-w-7xl mx-auto w-full px-4 py-16 md:py-24">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            {/* Left: Sticky Deep Dive Content */}
            <div className="w-full lg:w-2/3">
              {/* Features Deep Dive */}
              <div className="mb-16">
                <h2 className="text-3xl font-display font-bold text-white mb-8 pb-4 border-b border-border-dark">
                  Core Capabilities
                </h2>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                          {feature.benefits.map((benefit, idx) => (
                            <div
                              key={idx}
                              className="flex items-center gap-2 text-sm text-slate-300 bg-white/[0.02] rounded-lg px-3 py-2"
                            >
            ...
            <div className="w-full lg:w-1/3">
              <div className="lg:sticky lg:top-28 flex flex-col gap-6">
                {/* Quick Stats Card */}
                <div className="bg-[#1e1a32] rounded-2xl p-6 border border-border-dark">
                ...
                {/* CTA Card */}
                <div className="bg-linear-to-br from-primary/20 to-transparent rounded-2xl p-6 border border-primary/30">
                  <h3 className="text-xl font-bold text-white mb-2">
                    Ready to start?
                  </h3>
