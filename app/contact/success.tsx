...
//             style={{
//               backgroundImage: `linear-gradient(rgba(59, 25, 230, 0.3) 1px, transparent 1px),
//                                linear-gradient(90deg, rgba(59, 25, 230, 0.3) 1px, transparent 1px)`,
...
//               <div className="relative w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-anime-cyan/20 to-anime-purple/20 border border-anime-cyan/30 flex items-center justify-center backdrop-blur-sm">
//                 <svg
...
//             <h1 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-anime-cyan via-white to-anime-pink tracking-tight mb-4 drop-shadow-[0_0_30px_rgba(6,182,212,0.3)]">
//               Message Sent
//             </h1>
//             <div className="flex items-center justify-center gap-4">
//               <span className="h-px w-16 bg-gradient-to-r from-transparent to-anime-cyan" />
//               <p className="text-anime-cyan text-sm md:text-base font-bold tracking-[0.3em] uppercase">
//                 Thank You For Your Inquiry
//               </p>
//               <span className="h-px w-16 bg-gradient-to-l from-transparent to-anime-cyan" />
//             </div>
//           </div>
...
//               <div className="absolute -inset-0.5 bg-gradient-to-r from-anime-purple to-primary rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500" />
...
//             {/* Ticket Card */}
//             <div className="group relative">
//               <div className="absolute -inset-0.5 bg-gradient-to-r from-anime-cyan to-anime-purple rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500" />
...
//                         <div className="w-8 h-8 rounded-full bg-gradient-to-br from-anime-purple to-primary flex items-center justify-center text-xs font-bold">
//                           JD
//                         </div>
      ...
      <div className="relative min-h-screen w-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-5 sm:p-8 md:p-12 relative z-10">
          ...
          <div className="text-center mb-10 md:mb-16">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-anime-cyan via-white to-anime-purple tracking-tight leading-none">
              Message Sent
            </h1>

            <div className="mt-5 flex items-center justify-center gap-4 sm:gap-6">
              <div className="h-px w-16 sm:w-20 bg-gradient-to-r from-transparent via-anime-cyan to-transparent" />
