...
const Page = () => {
  return (
    <Layout>
      ...
      <div className="w-full p-4 sm:p-6 lg:p-8 flex flex-col lg:flex-row gap-8">
            ...
            <div className="p-5">
              ...
              <div className="space-y-3">
                ...
                <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-black/40">
                  <div className="h-full w-[84%] bg-linear-to-r from-primary to-purple-500"></div>
                </div>
              </div>
        ...
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 leading-relaxed text-base md:text-lg">
                  Results-driven developer with over 5 years of experience
                  delivering high-quality digital solutions. I specialize in
                  building scalable frontend architectures and robust backend
                  systems. Like any dedicated professional, I`m continuously
                  expanding my expertise and mastering new technologies.
                  Currently focused on advanced WebGL implementations and
              ...
              <div className="space-y-5">
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[95%] rounded-full bg-linear-to-r from-red-500 to-orange-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]"></div>
                    <div className="absolute top-0 left-0 h-full w-full bg-linear-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:animate-[shimmer_1.5s_infinite]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[88%] rounded-full bg-linear-to-r from-red-500 to-orange-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[82%] rounded-full bg-linear-to-r from-red-500 to-orange-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[98%] rounded-full bg-linear-to-r from-red-500 to-orange-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-surface-border bg-surface-dark p-6">
              ...
              <div className="space-y-5">
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[75%] rounded-full bg-linear-to-r from-blue-500 to-cyan-400 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[80%] rounded-full bg-linear-to-r from-blue-500 to-cyan-400 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[90%] rounded-full bg-linear-to-r from-blue-500 to-cyan-400 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative h-3 w-full overflow-hidden rounded-full bg-black/40">
                    <div className="absolute top-0 left-0 h-full w-[65%] rounded-full bg-linear-to-r from-blue-500 to-cyan-400 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 rounded-2xl border border-surface-border bg-surface-dark p-6">
              <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                <MdPsychology className="text-purple-400" />
                Core Competencies
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="rounded-lg bg-surface-border/30 p-4 hover:bg-surface-border/50 transition-colors cursor-default">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-1.5 rounded bg-yellow-500/20 text-yellow-500">
                  ...
                  <p className="text-xs text-slate-400">
                    Rapidly master new frameworks and technologies.
                  </p>
                </div>
                <div className="rounded-lg bg-surface-border/30 p-4 hover:bg-surface-border/50 transition-colors cursor-default">
                  <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-slate-400">
                    Efficient debugging in production environments.
                  </p>
                </div>
                <div className="rounded-lg bg-surface-border/30 p-4 hover:bg-surface-border/50 transition-colors cursor-default">
                  <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-slate-400">
                    Foster collaboration during project planning.
                  </p>
                </div>
                <div className="rounded-lg bg-surface-border/30 p-4 hover:bg-surface-border/50 transition-colors cursor-default">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-1.5 rounded bg-red-500/20 text-red-500">
                      <MdCoffee className="text-xl" />
                    </div>
                    <h4 className="font-bold text-slate-100">
                      High Performance
                    </h4>
                  ...
                  <p className="text-xs text-slate-400">
                    Consistent delivery under tight deadlines.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-surface-border bg-surface-dark p-6 flex flex-col items-center justify-center">
              <h3 className="text-lg font-bold text-white mb-2 w-full text-left">
                Skills Assessment
              </h3>
              <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                <svg
                  className="absolute w-full h-full drop-shadow-[0_0_10px_rgba(59,25,230,0.5)]"
                  viewBox="0 0 100 100"
                >
                  <polygon
                    className="animate-[pulse_3s_infinite]"
                    fill="rgba(59, 25, 230, 0.4)"
                    points="50,10 90,30 85,70 50,85 15,65 20,30"
                    stroke="#3b19e6"
                    strokeWidth="2"
                  ></polygon>
                </svg>

                <div className="absolute top-0 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  TECH
                </div>
                <div className="absolute bottom-0 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  LEAD
                </div>
                <div className="absolute top-12 left-1 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  ARCH
                </div>
                <div className="absolute top-12 right-1 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  PERF
                </div>
                <div className="absolute top-[80%] left-4 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  COMM
                </div>
                <div className="absolute top-[80%] right-4 text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-surface-dark px-1">
                  INNOV
                </div>
              </div>
            </div>
